...
from numpy import sin, zeros, interp as npinterp, sqrt as npsqrt, abs, minimum
...
def get_max_accel(v_ego):
  return float(interp(v_ego, A_CRUISE_MAX_BP, A_CRUISE_MAX_VALS))
...
class LongitudinalPlanner:
  ...
  def parse_model(model_msg, v_ego, taco_tune):
    ...
    if taco_tune:
      ...
      curvatures = npinterp(T_IDXS_MPC, ModelConstants.T_IDXS, model_msg.orientationRate.z) / clip(v, 0.3, 100.0)
