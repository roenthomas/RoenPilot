...
HONDA_NIDEC_PEDAL_TUNE = CAR.with_flags(HondaRoenPilotFlags.NIDEC_PEDAL_TUNE)
HONDA_NIDEC_PEDAL_DEADZONE = CAR.with_flags(HondaRoenPilotFlags.NIDEC_PEDAL_DEADZONE)
